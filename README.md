这个属于小团体的学习组吧，一个班级的学生用这个交流也没有问题，是可以自己部署在自己的服务器上的，当然只是好玩而已，实际上没有太大的作用
# 计算机修行录
...
| 鉴权 | bcrypt / Token (7天过期) / 密码修改 / 安全审计 |
...
| v3.3 | 2026-06-26 | 深色模式/导航栏/设置面板/消息路由修复、突破消息 |
| v3.4 | 2026-06-27 | 安全加固：密码修改API / 安全审计 / fail2ban / SSH密钥登录 / DB备份 |
